...
//     [Header("Screen Space Emoji System")]
//     [SerializeField] private WorldSpaceEmojiPool emojiPool;
//     [SerializeField] private bool useScreenSpaceEmojis = true;
...
//     // Track which cars have triggered close calls recently
...
//         if (emojiPool == null && useScreenSpaceEmojis)
//         {
//             Debug.LogWarning("ScreenSpaceEmojiPool not assigned! Screen space emojis will not work.");
//         }
...
//             // Handle close call UI and emojis (separate check)
...
//             // Show screen space emoji
//             if (useScreenSpaceEmojis && emojiPool != null)
//             {
//                 emojiPool.ShowEmoji(emojiType, trafficPosition, trafficForward);
//             }
...
public class CloseCallSystem : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // if (emojiPool == null && useWorldSpaceEmojis)
        // {
        //     LogHelper.LogWarning("WorldSpaceEmojiPool not assigned! World space emojis will not work.");
    ...
    private void EvaluateCloseCall(float distance, TrafficVehicleBehavior trafficCar, Vector3 trafficPosition, Vector3 trafficForward)
    {
        ...
        if (!string.IsNullOrEmpty(message))
        {
            ...
            // if (useWorldSpaceEmojis && emojiPool != null)
            // {
            //     emojiPool.ShowEmoji(emojiType, trafficPosition, trafficForward);
            // }
